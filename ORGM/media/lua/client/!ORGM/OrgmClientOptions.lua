...
function MainOptions:create()
    ...
    addNumericOption(self, splitpoint, comboWidth, "orgm_hitchance", "DefaultHitChance", false)
    ...
    addNumericOption(self, splitpoint, comboWidth, "orgm_magreloadtime", "DefaultMagazineReloadTime", false)
